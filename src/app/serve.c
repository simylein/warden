...
file_t not_found = {.fd = -1,
										...
										.hydrated = false,
										.lock = PTHREAD_RWLOCK_INITIALIZER};
file_t method_not_allowed = {.fd = -1,
														 .ptr = NULL,
														 .len = 0,
...
file_t uri_too_long = {.fd = -1,
											 ...
											 .hydrated = false,
											 .lock = PTHREAD_RWLOCK_INITIALIZER};
file_t request_header_fields_too_large = {.fd = -1,
																					.ptr = NULL,
																					.len = 0,
																					...
																					.hydrated = false,
																					.lock = PTHREAD_RWLOCK_INITIALIZER};
file_t internal_server_error = {.fd = -1,
																.ptr = NULL,
																.len = 0,
																...
																.hydrated = false,
																.lock = PTHREAD_RWLOCK_INITIALIZER};
file_t http_version_not_supported = {.fd = -1,
																		 .ptr = NULL,
																		 .len = 0,
